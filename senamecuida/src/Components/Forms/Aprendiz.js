...
const Visitante = () => {
    ...
    function prevent() {
        ...
        var NF = document.querySelector('#numeroFicha');
    ...
    async function registroNE(valores) {
        ...
        var ficha = document.querySelector('#numeroFicha').value;
        var programa = document.querySelector('#programaDeFormacion').value;
        if (reg.test(address) == false) {
            ...
            return (false);
        } else if (ficha.length < 7) {
            Swal.fire({
                icon: 'error',
                title: '¡Error!',
                text: "¡Debes ingresar un numero de ficha valido!",
                timer: 10500
            })
            return (false);
        } else if (programa.length < 10) {
            Swal.fire({
                icon: 'error',
                title: '¡Error!',
                text: "¡Debes ingresar un programa de formación valido!",
                timer: 10500
            })
            return (false);
        } else {
        ...
        <div className='containerForm'>
            ...
            <div style={{width: '100%', marginTop: '1.5%'}}>
                <TextField
                    ...
                    type='text'
                    label='Ficha'
                    placeholder='Ingresa tu ficha de programa'
                    variant="outlined"
                />
            </div>
            <div style={{width: '100%', marginTop: '1.5%'}}>
                <TextField
                    ...
                    placeholder='Ingresa tu programa De Formacion'
                    variant="outlined"
                />
            </div>
